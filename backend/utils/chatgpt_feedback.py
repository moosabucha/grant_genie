...
def _extract_keywords(text):
    stop_words = {
        ...
        'their', 'which', 'would', 'about', 'also', 'into', 'more', 'some',
        'than', 'then', 'them', 'they', 'were', 'when', 'what', 'where',
        'could', 'should', 'shall', 'make', 'made', 'such', 'each', 'both',
        'used', 'using', 'these', 'those', 'through', 'during', 'before',
        'after', 'above', 'below', 'between', 'under', 'while', 'within',
        # Common academic words to ignore
        'research', 'researcher', 'university', 'study', 'studies',
        'project', 'projects', 'provide', 'provides', 'provided',
        'develop', 'develops', 'development', 'based', 'approach',
        'including', 'novel', 'using', 'apply', 'applied', 'work',
        'enable', 'enables', 'innovative', 'information', 'primary',
        'areas', 'results', 'methods', 'method', 'analysis', 'data',
        # Names — ignore short proper nouns
        'sarah', 'mitchell', 'doctor', 'professor', 'lecturer',
        'senior', 'junior', 'early', 'career', 'centre', 'college',
    }
    ...
    domain_keywords = [
        ...
        'healthcare', 'medical', 'clinical', 'cancer', 'disease',
        'climate', 'carbon', 'sustainability', 'renewable', 'energy',
        'cybersecurity', 'blockchain', 'encryption', 'network',
        'robotics', 'engineering', 'quantum', 'physics', 'biology',
        'genomics', 'drug', 'therapy', 'vaccine', 'biomedical',
        'data science', 'statistics', 'modelling', 'simulation',
        'social', 'policy', 'education', 'equality', 'community',
    ]
